...
public class Messages {
    ...
    public static final String PREFIX = "§8[§eBedWars§8] §r";

    public static final String ARENA_FULL = "§cThis arena is already full!";
    public static final String PLAYER_IS_IN_THIS_GAME = "§cYou already connected in this game!";
